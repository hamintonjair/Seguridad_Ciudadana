...
$github_url = 'https://raw.githubusercontent.com/hamintonjair/ml_scripts/main/patrones_barrios.csv';
                            ...
                            <?php foreach ($data as $row): ?>
                                <div class="col-md-4">
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-body">
                                            <p style="color:black;"><strong>Total de Incidencias:</strong> <?php echo htmlspecialchars($row['cantidad']); ?></p>
                                            <p style="color:black;"><strong>Predicción de Regresión Promedio:</strong> <?php echo number_format((float)$row['cantidad_pred'], 3, '.', ''); ?></p>
                                            <p style="color:black;"><strong>Moda de Predicción de Clasificación:</strong> <?php echo htmlspecialchars($row['prediccion_clasificacion_mode']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        <a href="<?php echo base_url(); ?>estadisticas" class="btn btn-primary">Volver</a>
                    </div>
                </div>
            </div>
        </div>
