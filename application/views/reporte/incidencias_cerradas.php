<main>
    <div class="container mt-5">
        <div class="row">
                        ...
                        <?php foreach ($incidencias as $incidencia) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-secondary ver-mas" onclick="ver_Mas(<?= $incidencia->id ?>);" title="Ver más"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal fade" id="detalleIncidencia_cerrada" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Detalles de la Incidencia cerrada</h5>
