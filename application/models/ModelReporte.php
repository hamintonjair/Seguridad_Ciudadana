...
class ModelReporte extends CI_Model {
    ...
    public function get_Incidencia( $idUsuario )
 {
   ...
   public function obtenerCantidadIncidenciasPorMes() {
    ...
    public function guardar_incidencia( $tipo_incidencia, $fecha, $hora, $barrio, $descripcion, $urgencia,
    $latitud, $longitud, $adjuntos, $idUsuario, $nombre_anonimo, $correo_anonimo ) {
